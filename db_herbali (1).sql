...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 17, 2022 at 10:21 AM
...
(1, 'AdobeStock_181218549-herbs-resize.jpeg', 'We Serve Fresh & Best Products', ' We Deliver Herbs and Mushrooms'),
(2, '202003131038-main_cropped_15840707461.jpg', 'A Healthy Herbal Lifestyle', ' We Deliver Herbs and Mushrooms'),
(3, 'warming-spices-FB.jpg', '100% Fresh & Organic', ' We Deliver Herbs and Mushrooms');
...
(1, 'Herbali', 'Your Best Adventure Partner', 'hyugadventure@gmail.com', '<p>Desa Mlokomanis Wetan Kecamatan Ngadirojo Kabupaten Wonogiri</p>', '085773222611', '', '88047274.jpeg', '117-1176328_awards-green-leaf-logo-png.png');
...
(7, 3, 'Temu giring ', 15000, 997, '', '', '0_9f73be2b-f614-469b-bae9-e7b7273479f6_720_720.jpg', 0, '0000-00-00'),
...
(14, 7, 'Jamur Kuping Kering Bokni Bokji Hitam Dried Black Fungus 40g', 13500, 1000, 'Deskripsi Jamur Kuping Kering Bokni Bokji Hitam Dried Black Fungus 40g Dried Black Fungus / Jamur Kuping Hitam &nbsp; isi 40 gr / bungkus &nbsp; Jamur kuping Hitam bagus dan tebal untuk kesehatam jantung, melancarkan peredaran darah. &nbsp; biasanya dimasak bersama Red Dates/ Angco dan jahe untuk mencegah jantung coroner. ', 'Deskripsi Jamur Kuping Kering Bokni Bokji Hitam Dried Black Fungus 40g\r\nDried Black Fungus / Jamur Kuping Hitam\r\n&nbsp;\r\nisi 40 gr / bungkus\r\n&nbsp;\r\nJamur kuping Hitam bagus dan tebal untuk kesehatam jantung, melancarkan peredaran darah.\r\n&nbsp;\r\nbiasanya dimasak bersama Red Dates/ Angco dan jahe untuk mencegah jantung coroner.\r\n&nbsp;\r\nManfaat Jamur Kuping\r\n- Melancarkan pencernaan\r\n- Meringankan gejala wasir\r\n- Baik untuk menurunkan berat badan\r\n- Mencegah anemia\r\n- Melancarkan sirkulasi darah\r\n- Aman dikonsumsi penderita diabetes\r\n- Menurunkan kadar kolesterol , dll', '8947130_24227ac8-8949-43ec-be8c-f08265ef01c6_800_800.jpg', 6, '2020-11-09'),
...
(20, 7, 'jamur shiitake 100gr jamur shitake jamur yoko hioko', 26000, 75, '', '', '13300713_aa161986-cbd3-411d-83de-aa888c95627b_350_350.jpg', 0, '0000-00-00'),
(21, 7, 'Jamur Matsutake', 3500000, 3, '', '', '22380879_89cfffa4-f0b6-4c17-835e-b1aeeb1eea3d_700_700.jpg', 1, '2020-11-10'),
...
INSERT INTO `tb_blog` (`id`, `tglUpload`, `penulis`, `judul`, `content`, `foto`, `view`) VALUES
(2, '2020-11-10', 'Admin ', 'Apa Manfaat Konsumsi Jamur?', 'Jamur konsumsi adalah salah satu bahan makanan yang cukup populer dan mudah ditemukan di pasar tradisional maupun supermarket. Dengan tekstur yang empuk dan hampir mirip dengan daging, jamur dianggap sebagai bahan makanan yang eksotis. Jamur konsumsi biasa digunakan di sebagian besar hidangan seperti sup, salad, atau tumis.\r\nAda berbagai macam jamur konsumsi, di antaranya jamur kancing, jamur kuping, jamur enoki, jamur shiitake, jamur tiram, dan jamur truffle yang mahal. Kebanyakan varietas jamur rendah kalori, penuh vitamin D, dan dikemas dengan antioksidan yang sehat.\r\nBerbicara mengenai manfaat jamur bagi kesehatan, sebuah penelitian yang dilakukan oleh Department of Nutrition Science di University of Buffalo menunjukkan bahwa mengonsumsi jamur secara rutin dapat memberikan efek menguntungkan pada pengelolaan berat badan dan fungsi kekebalan tubuh. Jamur juga dapat berguna dalam mengatur kadar glukosa.', 'ILUSTRASI-JAMUR-FREEPIK-090919.jpg', 0),
(3, '2020-11-10', 'Admin ', 'Apa Itu Empon-empon?', 'Empon-empon yang memiliki nama dasar empu merupakan istilah yang digunakan untuk memberi nama bagian tanaman yang kaya akan senyawa yang dikandungnya. Empon-empon adalah minuman sejenis jamu yang sudah dikonsumsi sejak zaman dulu. Biasanya ramuan minuman tradisional ini terdiri dari jahe, kunyit, temulawak, dan rempah-rempah lainnya.\r\nSebagian orang ada yang langsung minum empon-empon itu tanpa campuran apa pun. Akan tetapi, ada beberapa yang menambahkan gula jawa agar ada rasa manisnya. Ketika diminum, empon-empon memiliki rasa agak pedas di lidah, tapi hangat di tenggorokan. Tidak ada takaran pasti untuk membuatnya, semua berdasarkan feeling dari seberapa banyak jumlah bahan-bahan untuk membuatnya.\r\nJika mengacu pada rempah-rempah yang dipakai untuk membuat empon-empon, pastinya terdapat beberapa manfaat baik untuk tubuh. Bahkan, rempah seperti kunyit, jahe, dan temulawak, diketahui mengandung antioksidan yang memang baik untuk kesehatan tubuh.\r\nMisalnya kunyit, menurut dr. Valda Gracia, bahan alami ini bisa membantu meredakan infeksi dan gangguan pernapasan. Seperti yang kita tahu, virus corona menyerang masalah pernapasan. Di sisi lain, khasiat temulawak juga tidak boleh diremehkan. Berkat kandungan kurkumin, temulawak terbilang baik untuk dikonsumsi. Kurkumin diketahui mampu membantu menekan risiko infeksi di dalam tubuh.', 'ilustrasi-blog-20Mar20.jpg', 1);
...
(10, 8, 'HIRYxJG8i1a2tWX', 'Triska', 'Mardiansyah', '081272125359', 'jl Hibrida X', 'Bengkulu', 1234, '2020-11-09', '0000-00-00', 'Proses'),
(11, 8, 'HIzO9PLnvoglVyM', 'test', 'test2', '08856533', 'jl test', 'bkl', 123, '2020-11-09', '0000-00-00', 'Proses');
...
(9, 'Admin', '', 'Sragen', '1996-07-13', 'Sragen', 'rahayupuspita@yahoo.co.id', '08321434523', 'admin', 'admin', 0, 1, NULL, '', ''),
(10, 'aaa', 'bbb', NULL, NULL, NULL, 'triska619@gmail.com', NULL, 'triska', '123', 0, 0, NULL, '', 'mJBYj6FZiKkoW9D'),
(11, 'Triska', 'Mardiansyah', NULL, NULL, NULL, 'triska619@gmail.com', NULL, '1234335', '123', 1, 1, NULL, '', 'ImJ6y8owBilQ5aX');
...
(12, '2020-11-09', 11, 1, 2),
(13, '2020-11-09', 11, 7, 2),
(14, '2020-11-09', 11, 20, 5);
...
--
ALTER TABLE `tb_pemesanan`
  MODIFY `idpemesanan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `vnota`
  MODIFY `nomornota` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
COMMIT;
