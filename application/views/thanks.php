...
<?php include 'includes/header.php'; ?>
  <title><?php echo $site[0]['sitename'] ?> - Payment Success</title>
...
<div style="width: 96%;margin-left: 2%;box-shadow: 0px 10px 10px 1px #333;font-family: andalus;">
        <div class="row" style="margin-top: 60px; margin-bottom: 30px">
          <div class="col-md-12 text-center">
            <br>
            <br>
            <span style="font-size: 100px;margin-top: 200px "><i class="fa fa-check-circle" aria-hidden="true" style="color:green"></i></span>
            ...
            <a href='<?php echo base_url()?>' type='button' class='flex-c-m stext-101 cl0 size-119 bg1 m-lr-auto bor14 hov-btn1 p-lr-15 trans-04 pointer' style='width:170px;'>Kembali Belanja</a>
          </div>
    </div><br>
</div>
<!-- Footer -->
