...
<?php include 'includes/header.php'; ?>
	<title><?php echo $site[0]['sitename'] ?> - Contact</title>
		...
		<div class="container">
			<div class="flex-w flex-tr">
				<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
					<form action="<?php echo base_url()?>page/messageSite" method="post">
						...
						<button class="flex-c-m stext-101 cl0 size-121 bg1 bor1 hov-btn1 p-lr-15 trans-04 pointer" name="pesan">
							Submit
						</button>
					</form>
				</div>
