...
<?php include 'includes/header.php'; ?>
	<title><?php echo $site[0]['sitename'] ?> - Register</title>
	...
	<section class="bg0 p-t-50 ">
		<div class="container">
				...
				<div class="col-md-6 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
					<form action="<?php echo base_url()?>page/registerUser" method="post" >					

						<div class="bor8 m-b-20 how-pos4-parent">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="nama_depan" placeholder="Nama Depan" required>
							<img class="how-pos4 pointer-none" src="<?php echo base_url()?>assets/images/icons/name.png" alt="ICON">
						</div>
						<div class="bor8 m-b-20 how-pos4-parent">
						...
						<div class="bor8 m-b-20 how-pos4-parent">
							...
							<img class="how-pos4 pointer-none" src="<?php echo base_url()?>assets/images/icons/id.png" alt="ICON">
						</div>
						<div class="bor8 m-b-20 how-pos4-parent">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="email" name="email" placeholder="Email" required>
							<img class="how-pos4 pointer-none" src="<?php echo base_url()?>assets/images/icons/email.png" alt="ICON">
						</div>
						<div class="bor8 m-b-20 how-pos4-parent">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="Password" name="password" placeholder="Password" required>
							<img class="how-pos4 pointer-none" src="<?php echo base_url()?>assets/images/icons/pass.png" alt="ICON">
						</div>
						...
						<button class="flex-c-m stext-101 cl0 size-121 bg1 bor1 hov-btn1 p-lr-15 trans-04 pointer" name="signup">
							REGISTER
						</button>
					</form>
				</div>
