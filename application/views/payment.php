...
<?php include 'includes/header.php'; ?>
	<title><?php echo $site[0]['sitename'] ?> - Payment</title>
    ...
    try{
      ...
      foreach($stmt as $row){
        ...
        <tr >
                  ...
                  <td >Rp. '.number_format($row['hargabarang'],0,',','.').' x <input class="mtext-104 cl3 txt-center num-product" type="number" id="idqty'.$i.'" name="num-product1" value="'.$row['banyak'].'" readonly></td>
                 
                  <td class="">
                  <input type="text" style="width:80px !important" id="idtotal'.$i.'" value="'.number_format($subtotal, 0,',','.').'">
                  </td>                </tr>
        ...
        $output2 .= '<tr class="table_row" ><td colspan="3" align="right">Total Belanja:  Rp.</td><td>'.number_format($total,0,',','.').'</td></tr> ';
                    ...
                    <div class="container" ><br>
                      ...
                      <div class="row m-b-100" style="padding: 0px;">
                        ...
                        <div class="col-md-6 mb-5 mb-md-0" style="padding: 0px">
                          <h2 class="h3 mb-3 text-black" style="border-left: 5px solid #82ae46; padding-left: 5px; font-family: Poppins-Bold;">Pembayaran</h2><br>
                          <div class="p-r-20">
                            <form class="form-horizontal" method="POST" action="<?php echo base_url()?>page/pembayaran" enctype="multipart/form-data">
                              <input type="hidden" name="kduser" value="<?php echo $user[0]['kduser']?>">
                        ...
                        <div class="col-md-6">
                              ...
                              <h2 class="h3 mb-3 text-black" style="border-left: 5px solid #82ae46; padding-left: 5px;font-family: Poppins-Bold;" >Keranjang</h2><br>
                              <div class="m-b-50">
