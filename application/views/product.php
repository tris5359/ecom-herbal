...
<?php include 'includes/header.php'; ?>
	...
	<title><?php echo $site[0]['sitename'] ?> - Product</title>
<body class="animsition">
  ...
  try{        
	  $jumlah = $this->db->query("SELECT COUNT(*) As jumlah FROM tb_barang")->result_array();
					...
					<div class="row isotope-grid">
						<?php             	                
			                try{
	  						  ...
	  						  $stmt = $this->db->query("SELECT * FROM tb_barang LIMIT  ".$offset.", ".$tampil."")->result_array();
			                  foreach($stmt as $row){
							...
							<div class="block2">
								<div class="block2-pic hov-img0">
									<img src="<?php echo base_url()?>assets/images/<?php echo $images ?>" style="height: 230px" alt="IMG-PRODUCT">
								...
								<div class="block2-txt flex-w flex-t p-t-14">
									<div class="block2-txt-child1 flex-col-l ">
										<a href="productDetail?Product=<?php echo $row['namabarang'] ?>&id=<?php echo $row['kodebarang'] ?>" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
